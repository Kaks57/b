    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex flex-wrap gap-4 mb-8 justify-center">
        <Button 
          ...
          className={genderFilter === "all" ? "bg-boutique-burgundy hover:bg-boutique-burgundy/90" : ""}
        ...
        <Button 
          ...
          className={genderFilter === "homme" ? "bg-boutique-burgundy hover:bg-boutique-burgundy/90" : ""}
        ...
        <Button 
          ...
          className={genderFilter === "femme" ? "bg-boutique-burgundy hover:bg-boutique-burgundy/90" : ""}
        ...
        <Button 
          ...
          className={genderFilter === "enfant" ? "bg-boutique-burgundy hover:bg-boutique-burgundy/90" : ""}
